...
| REPORT_ACCESS_CODE | Kode akses panjang dan acak yang dibagikan hanya kepada tim |

REPORT_ACCESS_CODE berbeda dari secret penghubung. Jangan memakai prefix NEXT_PUBLIC_ untuk ketiga variabel ini. Atur Vercel Firewall rate limiting untuk /api/reports sesuai kebutuhan tim.
...
Masuk memakai kode akses. Simpan satu report, lalu buka website dari browser/perangkat kedua memakai kode akses yang sama. Pastikan report dan kategori muncul. Dashboard memuat ulang setiap 30 detik saat terbuka, saat tab kembali aktif, atau lewat tombol Muat ulang.
...
- Seluruh pemegang kode akses tim bisa melihat kedua divisi. Belum ada login atau hak akses per orang.
